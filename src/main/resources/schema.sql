...
(
    ...
    CONSTRAINT remi_comp FOREIGN KEY
(
    company_id
...
(
    ...
    CONSTRAINT remi_contract FOREIGN KEY
(
    contract_id
...
(
    ...
    CONSTRAINT interested_id FOREIGN KEY
(
    interested_id
) REFERENCES interested
(
    interested_id
),
    CONSTRAINT remi_inter UNIQUE
(
    reminder_id,
    interested_id
)
...
(
    ...
    CONSTRAINT phone_interest FOREIGN KEY
(
    interested_id
) REFERENCES interested
(
