...
(
    contract_id      int8 GENERATED BY DEFAULT AS IDENTITY,
    contract_number  varchar(255),
    contract_type_id int8,
    PRIMARY KEY (contract_id),
    CONSTRAINT contract_type FOREIGN KEY (contract_type_id) REFERENCES contracts_type(contract_type_id)
);

CREATE TABLE IF NOT EXISTS reminders
(
    reminder_id   int8 GENERATED BY DEFAULT AS IDENTITY,
    extended_date date,
    initial_date  date,
    company_id    int8,
    contract_id   int8,
    PRIMARY KEY (reminder_id),
    CONSTRAINT remi_comp FOREIGN KEY (company_id) REFERENCES companies(company_id),
    CONSTRAINT remi_contract FOREIGN KEY (contract_id) REFERENCES contracts(contract_id)
);
...
(
    ...
    CONSTRAINT reminder_id FOREIGN KEY (reminder_id) REFERENCES reminders(reminder_id),
    CONSTRAINT interested_id FOREIGN KEY (interested_id) REFERENCES interested(interested_id),
    CONSTRAINT remi_inter UNIQUE (reminder_id, interested_id)
);
